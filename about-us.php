      ...
      <section class="section section-lg bg-default">
        <div class="container container-bigger">
          <div class="row row-50 justify-content-md-center align-items-lg-center justify-content-xl-between flex-lg-row-reverse">
            ...
            <div class="col-md-10 col-lg-6"><img src="images/img/about/about-us-1-720x459.jpeg" alt="" width="720" height="459"/>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row row-50 row-xxl-90 justify-content-sm-center offset-custom-2">
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-07-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-08-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-09-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-10-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-12-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-13-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-14-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-3">
              <div class="team-classic team-classic-circle">
                <figure><img class="rounded-circle" src="images/img/about/team-15-300x300.jpeg" alt="" width="300" height="300"/>
                </figure>
                <div class="team-classic-caption">
          ...
          <div class="row row-fix row-50 justify-content-sm-center justify-content-xl-between">
            ...
            <div class="col-sm-10 col-md-12 col-xl-4">
              <div class="row row-30">
                <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".1s"><img src="images/img/about/about-us-2-420x280.jpeg" alt="" width="420" height="280"/>
                </div>
                <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".2s"><img src="images/img/about/about-us-3-420x280.jpeg" alt="" width="420" height="280"/>
                </div>
                <div class="col-md-4 col-xl-12 wow fadeInUp" data-wow-delay=".3s"><img src="images/img/about/about-us-4-420x280.jpeg" alt="" width="420" height="280"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row row-50" data-lightgallery="group">
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-1-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-1-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-2-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-2-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-3-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-3-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-4-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-4-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-5-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-5-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4"><a class="gallery-item titled-gallery-item" href="images/project-6-1200x800-original.jpg" data-lightgallery="item">
                <div class="gallery-item-image">
                  <figure><img src="images/img/about/project-6-570x380.jpeg" alt="" width="570" height="380"/>
                  </figure>
                  <div class="caption">
                  </div>
                </div></a>
