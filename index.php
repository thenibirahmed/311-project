    ...
    <!-- Page-->
        ...
        <div class="rd-navbar-wrap rd-navbar-corporate">
          <nav class="rd-navbar" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-xl-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-fixed" data-xl-device-layout="rd-navbar-static" data-md-stick-up-offset="130px" data-lg-stick-up-offset="100px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true">
              ...
              <div class="rd-navbar-top-panel-inner">
                <ul class="list-inline">
					<li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-phone"></span>
						<ul class="list-comma">
						<li><a href="tel:+8801798449001">+880 1798 449 001</a></li>
						</ul>
					</li>
					<li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-map-marker"></span><a href="#">Uttara Dhaka</a></li>
					<li class="box-inline list-inline-item"><span class="icon novi-icon icon-md-smaller icon-secondary mdi mdi-email"></span><a href="mailto:thenibirahmed@gmail.com">thenibirahmed@gmail.com</a></li>
                </ul>
                <ul class="list-inline">
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-aside-right"><a class="button button-sm button-secondary button-nina" href="search_tour.php">Book a tour now</a></div>
            </div>
          </nav>
        </div>
      </header>
        ...
        <div class="swiper-form-wrap">
          <!-- Swiper-->
			<div class="swiper-container swiper-slider swiper-slider_height-1 swiper-align-left swiper-align-left-custom context-dark bg-gray-darker" data-loop="false" data-autoplay="5500" data-simulate-touch="false" data-slide-effect="fade">
				...
				<div class="swiper-slide" data-slide-bg="images/img/swiper-slide-1.jpeg">
				...
				<div class="swiper-slide" data-slide-bg="images/img/swiper-slide-2.jpeg">
					<div class="swiper-slide-caption">
					<div class="container container-bigger swiper-main-section">
						<div class="row row-fix justify-content-sm-center justify-content-md-start">
						<div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5">
				...
				<div class="swiper-slide" data-slide-bg="images/img/swiper-slide-3.jpeg">
					<div class="swiper-slide-caption">
					<div class="container container-bigger swiper-main-section">
						<div class="row row-fix justify-content-sm-center justify-content-md-start">
						<div class="col-md-6 col-lg-5 col-xl-4 col-xxl-5">
              ...
              <div class="col-lg-6 col-xxl-5">
                <div class="form-request form-request-modern bg-gray-lighter novi-background">
                  <h4>Find your Tour</h4>
                  	...
                  	<!-- RD Mailform-->
					<form class="" action="search_tour.php">
						...
						<div class="col-sm-12 col-lg-6">
							...
							<!-- Select -->
							<input class="form-input" id="dateForm" name="start_date" type="text" data-time-picker="date">
						...
						<div class="col-sm-12 col-lg-6">
							...
							<div class="form-wrap form-wrap-validation">
							<!-- Select 2-->
							<select class="form-input" data-placeholder="All" data-minimum-results-for-search="Infinity" name="duration">
						...
						<div class="col-lg-6">
							...
							<input class="form-input input-append" name="adults" id="form-element-stepper" type="number" min="0" max="300" value="2">
							</div>
						</div>
						<div class="col-lg-6">
							<label class="form-label-outside">Children</label>
							<div class="form-wrap form-wrap-modern">
							<input class="form-input input-append" name="childs" id="form-element-stepper-1" type="number" min="0" max="300" value="0">
							</div>
						</div>
						</div>
						<div class="form-wrap form-button">
						<input class="button button-block button-secondary" type="submit" value="Search">
						</div>
					</form>
      ...
      <section class="section section-variant-1 bg-default novi-background bg-cover">
        <div class="container container-wide">
			...
			<?php $tour_images = [
				'images/img/landing-private-airlines-01-570x370.jpeg',
				'images/img/landing-private-airlines-02-570x370.jpeg',
				'images/img/landing-private-airlines-03-570x370.jpeg',
				'images/img/landing-private-airlines-04-570x370.jpeg',
				'images/img/landing-private-airlines-05-570x370.jpeg',
				'images/img/landing-private-airlines-06-570x370.jpeg',
			] ?>
			<div class="row row-50">
				<?php 
					$sql = "SELECT * from `tours`";
					$tours = mysqli_query($conn, $sql);
					while( $tour = mysqli_fetch_assoc($tours) ) :
				?>
				<div class="col-md-6 col-xl-4">
					<article class="event-default-wrap">
						<div class="event-default">
							<figure class="event-default-image"><img src="<?php echo $tour_images[array_rand($tour_images,1)] ?>" alt="" width="570" height="370"/>
							</figure>
          ...
          <div class="row row-50">
            <div class="col-sm-12">
              ...
              <div class="owl-carousel owl-carousel-team owl-carousel-inset" data-items="1" data-md-items="2" data-xl-items="3" data-stage-padding="15" data-loop="true" data-margin="30" data-mouse-drag="false" data-dots="true" data-autoplay="true">
				<article class="post-blog"><a class="post-blog-image" href="#"><img src="images/img/landing-private-airlines-7-570x415.jpeg" alt="" width="570" height="415"/></a>
				...
				<article class="post-blog"><a class="post-blog-image" href="#"><img src="images/img/landing-private-airlines-8-570x415.jpeg" alt="" width="570" height="415"/></a>
					<div class="post-blog-caption">
						<div class="post-blog-caption-header">
						<ul class="post-blog-tags">
				...
				<article class="post-blog"><a class="post-blog-image" href="#"><img src="images/img/landing-private-airlines-9-570x415.jpeg" alt="" width="570" height="415"/></a>
					<div class="post-blog-caption">
						<div class="post-blog-caption-header">
						<ul class="post-blog-tags">
        ...
        <div class="container container-bigger">
          ...
          <div class="owl-carousel owl-layout-1" data-items="1" data-dots="true" data-nav="true" data-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-autoplay="true">
            <article class="quote-boxed">
				<div class="quote-boxed-aside"><img class="quote-boxed-image" src="images/img/quote-user-1-210x210.jpeg" alt="" width="210" height="210"/>
				</div>
