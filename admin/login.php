...
<head>
    ...
    <title>NSU Traveling Zone - Login</title>
                    ...
                    if(isset($_POST['login'])){
                        ...
                        if( ! empty($email) && ! empty($password) ){                
                            ...
                            if($row['password'] == md5($password)){
                                ...
                                $errors['not_matched'] = 'Email and password are inccorrect';
                            }
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <?php echo isset( $errors['not_matched'] ) ? "<span style='color: red; margin: 5px 12px'>{$errors['not_matched']}</span>" : '' ?>
                                    </div>
