                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create a Admin Account!</h1>
                            </div>
                            <?php
                                ...
                                if ( isset( $_POST['register'] ) ) {
                                    ...
                                    if ( ! empty( $fname ) && ! empty( $lname ) && ! empty( $email ) && ! empty( $password ) && ! empty( $phone ) && $password == $pass_conf  ) {                                        
                                        ...
                                        if(mysqli_num_rows($result) > 0){
                                            ...
                                            $sql = "INSERT INTO users (fname, lname, email, phone, password, role) VALUES ('$fname', '$lname', '$email', '$phone', '$password', 'admin')";
                            ...
                            <form class="user" action="" method="POST">
                                ...
                                <input name="register" type="submit" class="btn btn-primary btn-user btn-block" value="Register Admin Account">
                                <hr>
                            ...
                            <div class="text-center">
                                ...
                                <a class="small" href="register.php">Customer Account</a> <br>
